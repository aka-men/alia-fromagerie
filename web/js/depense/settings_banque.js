$(document).ready(function(){
    ...
    $("#table-banques").DataTable({
        ...
        'info': false,
        "ajax": {
            "url": $("#table-banques").attr('data-href'),
            "type": "POST",
            "data": function (d) {
    ...
    $("#length").on('change',function(){
        $("#table-banques").DataTable().page.len($("#length").val()).draw();
    });
    ...
    $("body").on('click','#add-banque,.edit-banque',function(){
        $this = $(this);
        $this.button('loading');
        $.get(
            $this.attr('data-href'),
    ...
    $("body").on('click','div#small-modal #submit',function(){
        if($("#appbundle_banque").length)
            $("#appbundle_banque").trigger('submit');
    });
    ...
    $("body").on('submit','#appbundle_banque',function(e){
        e.preventDefault();
        $this = $(this);
    ...
    $("body").on('click','.banque-toggle-state',function(){
        $this = $(this);
        $this.button('loading');
        $.post(
            $this.attr('data-href'),
    ...
    $("body").on('click','.delete-banque',function(){
        $this = $(this);
        swal({
                title: "Voullez-vous supprimer cette banque ?",
                type: "warning",
